$((function ($) { 
    return function () {
        ...
        var testElem = document.createElement('test'),
            ...
            runit = /^(-?[\d+\.\-]+)([a-z]+|%)$/i,
            convert = { 'inToPx': 1 / 92 },
            conversions = [1 / 25.4, 1 / 2.54, 1 / 6, 1 / 72],
        ...
        while (i--) {
            convert[units[i] + "ToPx"] = conversions[i] ? conversions[i] : $.css.toPx(testElem, '1' + units[i]);
        }
        ...
        function curCSS(elem, prop) {
            ...
            //console.log('curCSS element, prop:', elem, prop);
            ...
            if (getComputedStyle) {
                ...
                || getComputedStyle(elem)[toCamelCase(prop)];
                ...
                value = $.fn.cssPx(elem, '1em', 'left', 1) + 'px';
            } else {
            ...
            if (unit === '%' && computedValueBug) {
                ...
                value = $.fn.cssPx(elem, value) + 'px';
            }
            return value;
        }

        $.fn.cssPx = function (prop, elem, value, force) { // elem, value, force are optional
            // use width as the default property, or specify your own
            //console.log('cssPx element:', elem);
            //console.log('cssPx $(this):', $(this));

            var prop = prop || 'width',
                elem = elem || $(this)[0],
                value = value || curCSS(elem, prop),
                force = force || false,
                style,
                inlineValue,
                ret,
